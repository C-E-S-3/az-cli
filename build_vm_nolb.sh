...
SUBSCRIPTION_ID="ITS-APPOPS-HRA-NUA01-PREP"
...
FRONTENDIP_NAME=$BASE_NAME-frontend
BACKENDIP_NAME=$BASE_NAME-backend-pool
...
#create_loadbalancer $RESOURCEGROUP_NAME $LOADBALANCER_NAME $FRONTENDIP $FRONTENDIP_NAME
...
#create_backend_pool $RESOURCEGROUP_NAME $BACKENDIP_NAME $NIC_NAME $LOADBALANCER_NAME
#create_public_ip $RESOURCEGROUP_NAME $NATGATEWAYIP_NAME
...
create_nic $RESOURCEGROUP_NAME $NIC_NAME $VNET_NAME $SUBNET_NAME $PUBLICIP_NAME $NSG_NAME
...
#add_inbound_nat_rule_lb $RESOURCEGROUP_NAME $NATRULE_NAME $NIC_NAME $LOADBALANCER_NAME $IPCONFIG_NAME
